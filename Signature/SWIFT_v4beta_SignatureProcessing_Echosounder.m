...
timestep = 512; % BurstHR length in seconds (all results based on this)
...
pcolor(Data.EchoSounder1FBin1_MatlabTimeStamp-datenum(2015,0,0),double(Data.EchoSounder1FBin1_Range),double(Data.EchoSounder1FBin1_Echo11000kHzBin1)')
hold on
if sum(good)~= 0, plot([SWIFT(good).time]-datenum(2015,0,0),min(z5),'ks','linewidth',5), else end
%pcolor(double(Data.BurstHR_VelBeam5)')
set(gca,'YDir','reverse')
